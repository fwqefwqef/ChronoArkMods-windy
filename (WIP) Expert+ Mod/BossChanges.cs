    ...
    public class ExpertPlusBossPlugin : BaseUnityPlugin
    {
            ...
            static void Prefix(ref string dataString)
            {
                ...
                foreach (var e in masterJson)
                {
                    ...
                    if (((Dictionary<string, object>)e.Value).ContainsKey("_gdeSchema"))
                    {
                        ...
                        // Living Armor: Give all of his attacks debuff resist reduced
                        if (e.Key == "SE_Armor_0_T")
                        {
                            List<string> a = new List<string>();
                            a.Add("B_Pierrot_Bat_1_T");
                        ...
                        if (e.Key == "S1_WitchBoss")
                        {
                            ...
                            (masterJson[e.Key] as Dictionary<string, object>)["atk"] = 4;
                            (masterJson[e.Key] as Dictionary<string, object>)["hit"] = 86;
                        }
                        ...
                        // Joker Card: increased to 2 cost
                        if (e.Key == "S_Joker_0")
                        {
                        ...
                        // Breathtaker and Death Scythe: Discards random skill
        ...
        class ReaperBuffPatch
        {
            ...
            static void Postfix(B_Reaper_3 __instance)
            {
                ...
                __instance.PlusPerStat.Damage = -15 + (__instance.StackNum - 1) * 15;
            }
        }
        ...
        class DorchiXSummonPatch
        {
            ...
            {
                hit.Damage(__instance.BChar, (int)((float)hit.GetStat.maxhp * 1f), false, true, false, 100, false, false);
                return false;
            }
        }
